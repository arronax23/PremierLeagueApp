...
class FootballClub extends Component {
  ...
  componentDidMount() {
    fetch(`https://api-football-v1.p.rapidapi.com/v2/teams/team/${this.options.id}`, {
      method: 'GET',
      headers: {
    ...
    /////////////////
    fetch(
      `https://api-football-v1.p.rapidapi.com/v2/players/squad/${this.options.id}/2019-2020`,
      {
        method: 'GET',
        headers: {
          'x-rapidapi-host': 'api-football-v1.p.rapidapi.com',
    ...
    ////////////////
    fetch(`https://api-football-v1.p.rapidapi.com/v2/coachs/team/${this.options.id}`, {
      method: 'GET',
      headers: {
        'x-rapidapi-host': 'api-football-v1.p.rapidapi.com',
